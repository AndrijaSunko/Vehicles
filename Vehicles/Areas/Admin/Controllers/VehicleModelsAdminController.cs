...
namespace Vehicles.Areas.Admin.Controllers
{
    [Area("Admin")]
    [Authorize(Roles = "Admin")]
    public class VehicleModelsAdminController : Controller
    {
        private readonly ApplicationDbContext _context;

        public VehicleModelsAdminController(ApplicationDbContext context)
        {
            _context = context;
        }
